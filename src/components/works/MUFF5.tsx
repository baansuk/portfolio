...
const MUFF5 = () => {
  ...
  return (
    <div className="w-full h-full noScroll flex flex-col justify-start items-center bg-[#e16812] font-md text-[#f6f3a3] leading-5">
      <div className="w-full h-[10%] font-md flex flex-row justify-between items-center fixed p-3 pl-8 text-xl bg-[#e16812]">
        <p>제5회 무중력영화제 브랜딩</p>{" "}
        <div
      ...
      <div
        className="w-full mt-[68px] h-[732px] flex flex-col justify-start items-center typeMuff5 overflow-y-auto overflow-x-hidden snap-y snap-mandatory relative"
        ref={modalRef}
      >
        <div className="w-full h-full flex flex-col lg:flex-row justify-start lg:justify-between items-center snap-center relative lg:p-10">
          <img
            ...
            src="/portfolio/muff5_poster.png"
            alt="muff related"
          />
          <img
            className="h-[100px] absolute bottom-[12%] lg:left-[6%] object-cover subpixel-antialiased"
            src="/portfolio/muff5_logo.png"
            alt="muff related"
          />
          <div className="lg:w-[55%] w-full h-[732px] lg:p-5 p-2 flex flex-col justify-start items-start z-10 mt-[10%]">
            <p className="font-black  px-3 underline">
              MUJUNGRYUCK FILM FESTIVAL SEOUL ‘22
            </p>
            <p className="p-3 text-left text-[14px] w-[55%]">
          ...
          <div className="lg:w-[55%] absolute lg:p-5 lg:bottom-[10%] bottom-[15%] lg:right-[3%] p-2 lg:flex flex-col justify-start items-end z-10 hidden ">
            ...
            <p className="p-3 text-right text-[14px] w-[55%]">
        ...
        <div className="w-full h-full flex flex-col lg:flex-row lg:justify-between justify-start items-start snap-center relative">
          ...
          <div className="absolute lg:px-10 w-full top-[15%] left-[20%] lg:h-[170px] lg:w-[58%] text-left bg-[#e16812]">
            ...
            <p className="p-3 text-[14px] w-full lg:bg-transparent ">
        ...
        <div className="w-full h-full flex flex-col lg:flex-row lg:justify-between justify-start items-start snap-center relative">
          ...
          <img
            ...
            src="/portfolio/muff5_merch-25.png"
            alt="mujungryuck film festival related"
          />
          <img
            className="lg:w-full absolute lg:left-0 -bottom-10 object-cover drop-shadow-lg"
            src="/portfolio/muff5_merch-26.png"
            alt="mujungryuck film festival related"
          />

          <div className="w-full h-[732px] relative flex flex-col justify-start items-end"></div>
          <div className="absolute lg:px-20 w-full h-[300px] top-[28%] right-0 lg:h-auto lg:w-[65%] text-right">
            <p className="px-3 font-black underline lg:bg-transparent ">
              ILLUSTRATIONS
            </p>
            <p className="p-3 text-[14px] lg:bg-transparent ">
        ...
        <div className="w-full h-full flex flex-col lg:flex-row lg:justify-between justify-start items-start snap-center relative">
          ...
          <div className="absolute lg:px-10 w-full h-[300px] top-[10%] right-0 lg:h-auto lg:w-[48%] text-left ">
            ...
            <p className="p-3 text-[14px] whitespace-pre-wrap ">
            ...
            <div className="p-3 text-[14px] whitespace-pre-wrap underline flex flex-col justify-start items-end ">
              ...
              <a
                className="flex flex-row gap-2 "
                href="https://drive.google.com/drive/folders/1EAvPTtnKWgBy11EstaKY_jxaswggbi_A?usp=sharing"
                target="_blank"
                rel="noopener noreferrer"
              >
                제5회 무중력영화제 사진 및 자료{" "}
