...
const MZYIllust = () => {
  ...
  return (
    <div className="w-full h-[800px] noScroll flex flex-col justify-start items-center bg-[#221b21] font-md text-[#f6dd62]">
      <div className="w-full h-[70px] font-md flex flex-row justify-between items-center fixed p-3 pl-8 text-xl bg-[#221b21]">
      ...
      >
        <div className="w-full h-full flex flex-col lg:flex-row justify-start lg:justify-between items-center snap-center relative lg:p-10">
          ...
          />
          <img
            className="h-[80px] absolute top-0 lg:right-0 object-cover subpixel-antialiased"
            src="/mzyIllust_logo.png"
            alt="mzy illustration"
          />
          <img
            className="h-[80px] absolute top-40 lg:left-10 object-cover subpixel-antialiased"
            src="/mzyIllust_twinkle.png"
            alt="mzy illustration"
          />
          <img
            className="h-[80px] absolute top-30 lg:right-10 object-cover subpixel-antialiased"
            src="/mzyIllust_twinkle.png"
            alt="mzy illustration"
          />
          ...
          <div className="lg:w-[40%] absolute left-0 top-0 w-full h-auto lg:p-5 p-2 flex flex-col justify-start items-start z-10 bg-[#221b21] ">
            ...
            <p className="p-3 text-left lg:text-base text-sm">
        ...
        <div className="w-full h-full flex flex-col lg:flex-row lg:justify-between justify-start items-start snap-center relative">
          <img
            className="h-[350px] absolute top-10 lg:right-10 object-cover drop-shadow-lg subpixel-antialiased"
            src="/mzyIllust_photo.png"
            alt="mzy illustration"
          />
